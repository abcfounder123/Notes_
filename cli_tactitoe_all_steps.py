...
# 9 ထည့်ရင် 2, 2 ထွက်ဖို့ အောက်က ပုံသေနည်းနဲ့တွက်နိုင်ပါတယ်။
p = 9
r = (p-1) // 3        # 2
c = (p-1) % 3         # 2
n[r][c] = "X"
...
Step.12   --->  move function အဖြစ်ပြောင်းပါတယ်။
...
Step.13.1   --->   row တစ်ခုခြင်းမှာ X တန်ဖိုးပါလား စစ်ပါမယ်။
...
Step.13.2   --->   Column တစ်ခုခြင်းမှာ X တန်ဖိုးပါလားစစ်ပါမယ်။
...
Step.20   --->   win message before break  
